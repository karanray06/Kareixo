...
export default function FileExplorer({ files, activeFile, onSelectFile, onNewFile }: FileExplorerProps) {
  return (
    <div className="flex flex-col h-full">
      <div className="px-4 py-2 text-[11px] font-bold text-graphite-400 tracking-wider uppercase flex justify-between items-center shrink-0">
        ...
        <div className="flex gap-1 opacity-60">
          <button className="hover:text-white" title="New File" onClick={onNewFile}>
