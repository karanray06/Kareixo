...
export default function ThinkingStep({ content, isStreaming }: ThinkingStepProps) {
  ...
  return (
    <div className="flex gap-3">
      ...
      <div className="flex-1 bg-cyan-400/5 border border-cyan-400/10 rounded-lg p-3">
        ...
        <div className="text-sm text-cyan-100/80 leading-relaxed whitespace-pre-wrap font-mono">
          {content || "Thinking..."}
        </div>
      </div>
    </div>
