...
<div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full stage-blur-card shadow-lg border border-dark-border mb-8 backdrop-blur-md">
<span className="relative flex h-2 w-2">
<span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-accent-ai-hover opacity-75"></span>
<span className="relative inline-flex rounded-full h-2 w-2 bg-accent-ai-hover"></span>
</span>
<span className="font-badge-mono text-badge-mono tracking-wider text-dark-text-primary uppercase">3D Cinematic AI Code Review · GitHub-Native</span>
</div>
